...
## Digital Divide Classwork Activities

### Activity 1: Digital Divide Data Analysis (15 minutes)

Using the datasets from the lesson, answer the following questions:

1. Which region has the highest and lowest internet penetration rates?
2. What is the percentage difference in broadband access between households earning less than $30,000 and those earning $75,000+?
3. Create a simple bar graph showing internet access by income level.
4. Write 2-3 sentences explaining what patterns you notice in the data.

### Activity 2: Digital Divide Scenario Response (15 minutes)

Read the following scenarios and answer the questions for each:

**Scenario 1:** Maria is a high school student in a rural area with only a shared smartphone at home and unreliable internet. She needs to complete online assignments.

**Scenario 2:** Robert is an elderly man who has never used a computer. During the pandemic, his doctor's appointments moved to telehealth visits.

**Scenario 3:** A small town has decent internet infrastructure, but 40% of residents can't afford monthly internet service.

For each scenario:
1. Identify which type of digital divide is present (access, usage, or quality)
2. Describe one specific consequence this might have on the person/community
3. Propose one practical solution that could help address the situation

### Activity 3: Digital Divide Solution Proposal (20 minutes)

Design a brief proposal to address one aspect of the digital divide in your community:

1. Identify a specific digital divide problem in your school or local community
2. Describe your proposed solution in 3-5 sentences
3. List 3 resources needed to implement your solution
4. Explain how you would measure whether your solution was successful

Your proposal should fit on a single page and be ready to share with the class.
